...
public class QuickStart {
    ...
    /**
     * Before run there are few options to auth with google:
     *
     * Option 1
     ...
     * Option 2
     * copy file
     * ./integration/google/document-ai/application_default_credentials.json
     * to
     * /home/USER/.config/gcloud/application_default_credentials.json
     *
     * Option 3
     * set env variable GOOGLE_APPLICATION_CREDENTIALS=integration/google/document-ai/application_default_credentials.json
     *
     * @param args
     * @throws Exception
     */
    public static void main(String[] args)
        ...
        String projectId = "profsys-9999";
        String location = "eu"; // Format is "us" or "eu".
        String processorId = "8615c5186dc9cd29";
        String filePath = new ClassFile(QuickStart.class).filePathWithExtension("png");
    ...
    public static void quickStart(
        ...
        // resources.
        String endpoint = new DocumentAiEndpoint().get();
